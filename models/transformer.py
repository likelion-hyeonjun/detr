...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed, pos_embed, need_weights = False):
        ...
        hs, attn_weight, image_attn_weight = self.decoder(tgt, memory, memory_key_padding_mask=mask,
